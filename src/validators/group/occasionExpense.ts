import { query, body, checkExact, param, check } from "express-validator";
...
export const getSingleOccasionExpenseValidators = [
  param("occasionId").exists().isMongoId().withMessage("Occasion ID is invalid."),
  param("expenseId").exists().isMongoId().withMessage("Expense ID is invalid."),
  query("groupId")
    .exists()
